...
export default function FAQ() {
    ...
    const faqs = [
        ...
        { q: "定例ミーティングやレポート報告はありますか？", a: "はい、毎月1回の定例オンラインミーティングにて、数値レポートを用いた振り返りと翌月の施策提案を行っております。" },
        { q: "契約後の解約はいつでも可能ですか？", a: "契約期間満了の1ヶ月前までにお申し出いただければ、契約更新のタイミングで解約が可能です。無理な引き止めは一切ございません。" },
        { q: "BtoB企業でも依頼できますか？", a: "はい、BtoB・BtoC問わず対応可能です。採用広報やリード獲得など、目的に応じたSNS戦略をご提案させていただきます。" },
        { q: "申し込みから開始までの期間は？", a: "通常、ご契約からアカウント開設・初期設定を含めて約2週間〜1ヶ月程度で運用を開始いただけます。" }
    ];
